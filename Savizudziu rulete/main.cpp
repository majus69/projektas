    ...
    if (randIndex == 0) {
        ...
        if(randIndex == 0){
            ...
            while(m != 0){
                ...
                cout << "Enter the number of item you want to use (max. 3 times, same name items can only be used once per turn). If you dont want to use any of your items enter 0: ";
                cin >> m;
